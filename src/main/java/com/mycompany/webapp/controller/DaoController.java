...
public class DaoController {
	...
	public String boardList(@RequestParam(defaultValue = "1") int pageNo, Model model) {
		...
		/*
		 * if (totalRows < 1000) { for (int i = 1; i <= 1000; i++) { Board board = new
		 * Board(); board.setBtitle("제목" + i); board.setBcontent("내용" + i);
		 * board.setMid("user"); boardService.writeBoard(board); } }
		 */
	...
	public void battachDownload(int bno, HttpServletResponse response) throws Exception {
		...
		String battachspath = "C:/Temp/" + battachsname;
